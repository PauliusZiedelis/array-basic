...
console.log('Masyve: ', arrayOfABCD, ` yra A - ${counterA}, yra B - ${counterB}, yra C - ${counterC}, yra D - ${counterD},`);
...
arrayOfABCD1.forEach((value, index) => {
    const string = arrayOfABCD1[index]+arrayOfABCD2[index]+arrayOfABCD3[index];
    sumOfArrayABCD.push(string);
    uniqueCombination.hasOwnProperty(string) ? uniqueCombination[string]++ : uniqueCombination[string] = 1;
})
...
console.log('Unikalių reikšmių yra: ', uniqueValue.length, ' Unikalios reikšmės yra ', uniqueValue);
